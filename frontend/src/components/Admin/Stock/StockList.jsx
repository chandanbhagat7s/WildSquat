        ...
        <div className="flex justify-center mb-4">
          <button
            ...
            className={`mr-2 px-4 py-2 ${
              gender === "male" ? "bg-indigo-600 text-white" : "bg-gray-300"
            } rounded-full`}
          >
            Male
          </button>
          <button
            ...
            className={`px-4 py-2 ${
              gender === "female" ? "bg-indigo-600 text-white" : "bg-gray-300"
            } rounded-full`}
          >
            Female
          </button>
                ...
                <div className="mb-4">
                  ...
                  <div className="grid grid-cols-2  gap-1">
                    {product.sizes.map((size) => (
                      <span
                        key={size.size}
                        className="px-2 py-2 border border-black rounded-md hover:border-indigo-800 transition duration-300"
                      >
